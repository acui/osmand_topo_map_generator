    ...
    def draw_scale_bar(self) -> svg.G:
        ...
        scale_texts.append(
            svg.Text(
                ...
                font_family=FONT_FAMILY,
                font_size= font_size,
                text=f"Generated by using OsmAnd Maps & Navigation https://osmand.net/",
                x=0,
...
if __name__ == "__main__":
    ...
    class Arguments(BaseSettings, cli_parse_args=True):
        ...
        zone_number: CliPositionalArg[int]
        zone_letter: CliPositionalArg[UTMZoneLetter]
        easting: CliPositionalArg[int]
        northing: CliPositionalArg[int]
        scale: CliPositionalArg[int]
        map_root: CliPositionalArg[Path]
    ...
    print(f"Take the screenshots and save them into the directory: {args.map_root}")
    ...
    print(f"Map image saved to {merged_image_file}.")
    top_left = corners[0]
    top_right = corners[1]
